...
function messUpPage() {
  ...
  $('.line').each(function () {
    var lineX = randomIntegerInRange(0,$(document).width());
    var lineY = randomIntegerInRange(0,$(document).height());
    var typesize = randomIntegerInRange(5,200);
...
function randomSize(element,min,max) {

  size = randomIntegerInRange(min,max);
